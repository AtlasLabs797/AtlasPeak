...
- `SEC-042`: SQLCipher 4.6.1 -> 4.11.0, con sus checksums en `gradle/verification-metadata.xml`
  (autorizado por el propietario; SHA-1 contrastados con Maven Central).
